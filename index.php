...
<body>
    ...
    <!-- ***** Hero Area Start ***** -->
    <div class="fancy-hero-area bg-img bg-overlay animated-img" style="background-image: url(img/bg-img/bg.png);">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Online Birth Certificate System 
