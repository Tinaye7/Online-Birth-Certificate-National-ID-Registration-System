...
if (strlen($_SESSION['obcsuid']==0)) {
 ...
 <div class="content-inner-all" style=margin-left:200px>
            <div class="header-top-area" style=margin-left:40px >
                <div class="fixed-header-top"style= background:#15a308 >
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-1 col-md-6 col-sm-6 col-xs-12">
                                <button type="button" id="sidebarCollapse" class="btn bar-button-pro header-drl-controller-btn btn-info navbar-btn" style= background:#c0c90e>
...
{               ?>
                                        <li class="nav-item">
                                            ...
                                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated flipInX" style= background:#c0c90e>
