...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT MobileNumber FROM users WHERE MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update users set Password=:newpassword where MobileNumber=:mobile";
...
<body class="materialdesign">
    ...
    <div class="wrapper-pro">
            ...
            <div class="login-form-area mg-t-30 mg-b-40">
                <div class="container-fluid" style="background-color:gray" style=margin-left:55px>
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <h1 style="color: yellow">Forgot Password</h1>
                                            </div>
                                        </div>
                                    </div>
