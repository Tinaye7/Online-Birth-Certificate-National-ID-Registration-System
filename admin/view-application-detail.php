...
$sql= "update application set Status=:status,Remark=:remark where ID=:vid";
...
<head>
    ...
    <title>Manage Application Form | Online Birth Certificate & ID Registration System</title>
    ...
    <div class="wrapper-pro">
      <?php include_once('includes/sidebar.php');?>
        <?php include_once('includes/header.php');?>
            ...
            <!-- Breadcome start-->
            <div class="breadcome-area mg-b-30 small-dn" style=margin-left:285px>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Birth Certificate Application Form</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <!-- Static Table Start -->
            <div class="data-table-area mg-b-15" style=margin-left:285px>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>View <span class="table-project-n">Details of</span> Birth Certificate Application</h1>
...
$sql="SELECT application.*,users.FirstName,users.LastName,users.MobileNumber,users.Address from  application join  users on application.UserID=users.ID where application.ID=:vid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':vid', $vid, PDO::PARAM_STR);
$query->execute();
...
<td colspan="4" style="font-size:20px;color:blue">
 ...
 <tr>
  ...
  <tr>
    ...
    <th scope>Birth Place of Father</th>
    <td><?php  echo $row->BirthofFather;?></td>
  </tr>
  <tr>
    <th scope>ID Number of Father</th>
    <td><?php  echo $row->IDofFather;?></td>
    <th scope>Name of Mother</th>
    <td><?php  echo $row->NameofMother;?></td>
  </tr>
  <tr>
    <th scope>Birth Place of Mother</th>
    <td><?php  echo $row->BirthofFather;?></td>
    <th scope>ID Number of Mother</th>
    <td><?php  echo $row->IDofMother;?></td>
  </tr>
  <tr>
