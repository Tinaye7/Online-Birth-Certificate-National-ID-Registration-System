...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM admin WHERE Email=:email and Username=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update admin set Password=:newpassword where Email=:email and Username=:mobile";
...
<head>
    ...
    <title>Forgot Password | Online Birth Certificate & ID Registration System</title>
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                               <h3 style="font-weight: bold;color: Green">Online Birth Certificate & ID Registration System</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <h1 style="color: yellow; text-align:right" class="label"  >Forgot Password</h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input type="text" name="mobile" placeholder="Username" required="true">
