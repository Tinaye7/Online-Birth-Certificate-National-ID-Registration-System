...
$birthoffather=$_POST['birthoffather'];
$idoffather=$_POST['idoffather'];
...
$ret="select DateofBirth from application where DateofBirth=:dob || NameofFather=:fname";
...
$query->bindParam(':birthoffather',$birthoffather,PDO::PARAM_STR);
$query->bindParam(':idoffather',$idoffather,PDO::PARAM_STR);
$query->bindParam(':nameofmother',$nameofmother,PDO::PARAM_STR);
$query->bindParam(':birthofmother',$birthofmother,PDO::PARAM_STR);
$query->bindParam(':idofmother',$idofmother,PDO::PARAM_STR);
...
echo "<script>alert('Date of Birth and Father Name already exists. Please try again!');</script>";
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                          ...
                                                          <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Birth Place of Father</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" required="true" value="" name="birthoffather" />
                                                                </div>
                                                            </div>
                                                         </div>
                                                         <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">ID Number of Father</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" required="true" value="" name="idoffather" />
                                                                </div>
                                                            </div>
</div>
<div class="form-group-inner">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Birth Place of Mother</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" required="true" value="" name="birthofmother" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">ID Number of Mother</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" required="true" value="" name="idofmother" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
