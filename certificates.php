...
<?php
$vid=$_GET['viewid'];
$sql="SELECT application.*,users.FirstName,users.LastName,users.MobileNumber,users.Address from  application join  users on application.UserID=users.ID where application.ID=:vid and  application.Status='Verified'";
